...
#### When completed, create an archive of `typescriptExercises` and submit it to Moodle for assessment BUT PLEASE DELETE THE node_modules FOLDER BEFORE ARCHIVING (it significantly reduces file size)
