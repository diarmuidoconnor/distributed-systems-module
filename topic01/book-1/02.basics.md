...
___You are required___ to use the same data typing approach to the colleague data. Pay attention to the Problems panel in VS Code for any errors. Rerun the script when completed.
