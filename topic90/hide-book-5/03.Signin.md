...
~~~
Note, a JWT token is returned with a successful login attempt. We use this token with subsequent requests as proof that the user has authenticated - we will test this later.
