...
The response should be successful. In CloudWatch, examine the log stream generated by the lambda handler that's integrated with this endpoint (`protected.ts'). Notice the information contained in the JWT token?
